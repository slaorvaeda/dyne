    ...
    >
      <CardContent sx={{ "&:last-child": { pb: 3 } }}>
        ...
        {hasData ? (
          ...
          <Box sx={{ width: "100%", height: 350, display: "flex", alignItems: "center", justifyContent: "center", color: "text.secondary" }}>
            <Typography variant="body2">No region data for selected period</Typography>
          </Box>
        )}
      </CardContent>
    </Card>
